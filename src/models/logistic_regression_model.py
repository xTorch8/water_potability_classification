...
def logistic_regression_model(X_train, y_train, X_val, y_val, file_path = "../src/models/logistic_regression_model.pkl"):
    try:
        ...
        print("Starting training Logistic Regression model process...")
        ...
        print("Training Logistic Regression model process completed.")
