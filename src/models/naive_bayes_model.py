...
def naive_bayes_model(X_train, y_train, X_val, y_val, file_path = "../src/models/saved_models/naive_bayes.pkl"):
    try:
        ...
        print("Starting training Naive Bayes model process...")
        ...
        print("Training Naive Bayes model process completed.")
